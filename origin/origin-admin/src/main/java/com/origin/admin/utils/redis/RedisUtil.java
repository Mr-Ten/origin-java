package com.origin.admin.utils.redis;
...
public class RedisUtil {
     ...
     * @return
     */
    public Long delete(Collection key){
        if (key == null){
            return  0L;
        }
        return redisTemplate().delete(new ArrayList(key));
    }
     ...
     * @return
     */
    public Set<String> getPrefixKey(String keys){
